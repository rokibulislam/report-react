                ...
                <div className="col-12 col-lg-6">
                    <div className="card card--add-api">
                        ...
                        <div className="form-group">
                            <label for="apiAccountName"> { t('Account Name' ) } </label>
                            <input type="text" className="form-control" id="apiAccountName"/>
                        </div>

                        <div className="form-group">
                            <label for="apiConsumerId"> { t('Consumer ID') } </label>
                            <input type="text" className="form-control" id="apiConsumerId"/>
                        </div>

                        <div className="form-group">
                            <label for="apiEmployeeId"> { t('Employee ID') } </label>
                            <input type="text" className="form-control" id="apiEmployeeId"/>
                        </div>

                        <div className="form-group">
                            <label for="apiExpirationDate"> { t('Expiration Date') }</label>
                            <input type="date" className="form-control" id="apiExpirationDate"/>
                        </div>

                        <div className="form-cta mt-4">
                            <button className="btn btn-primary mr-3"> { t('Add Account') } </button>
